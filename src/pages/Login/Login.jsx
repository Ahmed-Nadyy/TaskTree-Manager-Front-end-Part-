                    ...
                    <div className="relative w-full rounded-3xl px-6 py-4 bg-gray-100 dark:bg-gray-800 shadow-md transition-colors duration-200">
                        ...
                        <form className="mt-10" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-7 flex">
                                <a className="w-full text-right underline text-sm text-gray-600 dark:text-gray-400 
                                    hover:text-gray-900 dark:hover:text-gray-200 transition-colors duration-200" href="#">
                                    Forgot Password?
                                </a>
                            </div>
                            <div className="mt-7">
