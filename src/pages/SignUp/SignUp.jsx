                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={loading}
                                className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white ${loading ? 'bg-blue-400 cursor-not-allowed opacity-75' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200`}
                            >
                                {loading && (
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleOTPSubmit}>
                        ...
                        <div className="flex flex-col space-y-3">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className={`text-sm font-medium flex items-center justify-center ${loading ? 'text-gray-400 cursor-not-allowed' : 'text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300'} focus:outline-none transition-colors duration-200`}
                            >
                                {loading && (
